...
if (typeof document !== 'undefined' && !document.getElementById(KEYFRAMES_ID)) {
    ...
    @keyframes pc-code-float {
      0% { opacity: 0; transform: translate(0, 0) rotate(var(--float-rot)); }
      15% { opacity: var(--float-peak); }
      50% { opacity: var(--float-peak); transform: translate(var(--float-dx), var(--float-dy)) rotate(var(--float-rot)); }
      85% { opacity: var(--float-peak); }
      100% { opacity: 0; transform: translate(calc(var(--float-dx) * 2), calc(var(--float-dy) * 2)) rotate(var(--float-rot)); }
    }
  `;
            ...
            <div ref={shellRef} className="relative z-[1] group">
                ...
                >
                    ...
                    >
                        ...
                        >
                            {[
                                { x: '12%', y: '8%', size: '2.2rem', delay: '0s', dur: '6s', rot: '-12deg', dx: '8px', dy: '15px', peak: '0.45' },
                                { x: '72%', y: '25%', size: '2.8rem', delay: '2s', dur: '7s', rot: '8deg', dx: '-10px', dy: '12px', peak: '0.5' },
                                { x: '25%', y: '55%', size: '2rem', delay: '4s', dur: '8s', rot: '-6deg', dx: '12px', dy: '-8px', peak: '0.4' },
                                { x: '65%', y: '70%', size: '2.5rem', delay: '1s', dur: '6.5s', rot: '15deg', dx: '-6px', dy: '10px', peak: '0.45' },
                                { x: '40%', y: '35%', size: '3rem', delay: '3s', dur: '7.5s', rot: '-4deg', dx: '10px', dy: '-12px', peak: '0.35' },
                            ].map((item, i) => (
                                <span
                                    key={i}
                                    className="absolute font-mono font-bold text-white/80 select-none"
                                    style={{
                                        left: item.x,
                                        top: item.y,
                                        fontSize: item.size,
                                        ...
                                        '--float-dx': item.dx,
                                        '--float-dy': item.dy,
                                        '--float-peak': item.peak,
                                        animation: `pc-code-float ${item.dur} ${item.delay} ease-in-out infinite`,
                                        opacity: 0
                        ...
                        >
                            <img
                                ...
                                onError={e => {
                                    ...
                                    console.error('ProfileCard image failed to load:', e);
                        ...
                        >
                            <div className="w-full absolute flex flex-col" style={{ bottom: '1.5em', display: 'flex', gridArea: 'auto' }}>
                                <h3
