...
interface ProfileCardProps {
    ...
    onContactClick?: () => void;
    // Added based on usage in request but not in interface
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    // Resolve props that might be passed with different names or defaults
    const resolvedInnerGradient = customInnerGradient ?? innerGradient ?? DEFAULT_INNER_GRADIENT;
    const resolvedBehindGlowEnabled = showBehindGlow ?? behindGlowEnabled;
    ...
    const cardStyle = useMemo(
        () => ({
            ...
            '--inner-gradient': resolvedInnerGradient,
        ...
        [iconUrl, grainUrl, resolvedInnerGradient, behindGlowColor, behindGlowSize, cardRadius]
    );
