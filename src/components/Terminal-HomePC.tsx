    ...
    switch (trimmedCmd) {
        ...
        addToOutput(
          <div className="space-y-2 text-terminal-cyan">
            ...
            <div className="pl-4 space-y-1 text-sm">
              <div>• <span className="text-terminal-yellow">projects</span> - Interactive project gallery</div>
              <div>• <span className="text-terminal-yellow">projects view 1-3</span> - Specific project details</div>
              <div>• <span className="text-terminal-yellow">skills</span> - Interactive skills visualization</div>
              <div>• <span className="text-terminal-yellow">contact</span> - Interactive contact hub</div>
            ...
            <div className="text-terminal-green text-xs mt-2">
              ◆ Commands show text here + interactive GUI in Live Output panel →
            </div>
          </div>
        );
        break;
      ...
      case 'projects':
        addToOutput(
          <div className="space-y-3 text-terminal-cyan">
            ...
            <div className="text-terminal-green text-xs mt-3">
              ◆ Check the Live Output panel for interactive project gallery →
            </div>
          </div>
        );
        ...
        if (onPreviewUpdate) {
          onPreviewUpdate({
            ...
            content: 'Interactive Projects Gallery',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
      ...
      case 'projects view 1':
        addToOutput(
          <div className="space-y-3 text-terminal-cyan">
            ...
            <div className="text-terminal-green text-xs mt-3">
              ◆ View interactive project gallery in Live Output →
            </div>
          </div>
        );
        
        // Show projects visual for individual project views too
        if (onPreviewUpdate) {
          onPreviewUpdate({
            type: 'projects_visual',
            content: 'Interactive Projects Gallery - Admin Dashboard',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
      ...
      case 'projects view 2':
        ...
        if (onPreviewUpdate) {
          onPreviewUpdate({
            type: 'projects_visual',
            content: 'Interactive Projects Gallery - E-commerce Platform',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
      ...
      case 'projects view 3':
        ...
        if (onPreviewUpdate) {
          onPreviewUpdate({
            type: 'projects_visual',
            content: 'Interactive Projects Gallery - Task Manager',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
      ...
      case 'skills':
        addToOutput(
          <div className="space-y-3 text-terminal-cyan">
            ...
            <div className="text-terminal-green text-xs mt-3">
              ◆ Check the Live Output panel for interactive skills visualization →
            </div>
          </div>
        );
        ...
        if (onPreviewUpdate) {
          onPreviewUpdate({
            type: 'skills_visual',
            content: 'Interactive Skills Visualization',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
      ...
      case 'contact':
        addToOutput(
          <div className="space-y-3 text-terminal-cyan">
            ...
            <div className="text-terminal-green text-xs mt-3">
              ◆ Check the Live Output panel for interactive contact hub →
            </div>
          </div>
        );
        ...
        if (onPreviewUpdate) {
          onPreviewUpdate({
            type: 'contact_visual',
            content: 'Interactive Contact Hub',
            timestamp: new Date().toLocaleTimeString()
          });
        }
        break;
